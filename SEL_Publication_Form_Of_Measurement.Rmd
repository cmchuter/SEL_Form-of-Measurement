...
myreport <- body_add_flextable(x = myreport, ft)
myreport <- body_add_par(x = myreport, value = "", style = "Normal")
...
### descriptive statistics
describeBy(dat$InterventionID,dat$self.report.m)
describeBy(dat$InterventionID,dat$teacher.report.m)
describeBy(dat$InterventionID,dat$peer.report.m)
describeBy(dat$InterventionID,dat$parent.report.m)
describeBy(dat$InterventionID,dat$observation.m)
describeBy(dat$InterventionID,dat$administrative.records.m)
describeBy(dat$InterventionID,dat$standardized.assessments.m)

describeBy(dat$InterventionID,dat$Targeted.m)

describeBy(dat$InterventionID,dat$primary.m)
describeBy(dat$InterventionID,dat$secondary.m)
describeBy(dat$InterventionID,dat$mixed.m)

describeBy(dat$InterventionID,dat$social.m)
describeBy(dat$InterventionID,dat$emo_and_problem.m)
describeBy(dat$InterventionID,dat$academic.m)

describeBy(dat$InterventionID,dat$qed.m)

# total studies
length(unique(dat$ES))
# number randomized
length(unique(dat$APA[which(dat$Randomized==1)]))
# number qed
length(unique(dat$APA[which(dat$Randomized==0)]))
```
